        ...
        <div className="container py-5">
            <div className="row align-items-center mb-5">
                <div className="col-lg-6">
                    ...
                    <button className="btn btn-primary btn-lg px-4 me-2" onClick={() => onNavClick('login')}>Join Now</button>
                    <button className="btn btn-outline-secondary btn-lg px-4" onClick={() => onNavClick('login')}>Demo</button>
                </div>
